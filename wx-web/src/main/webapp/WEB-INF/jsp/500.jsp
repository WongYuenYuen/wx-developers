...
<head>
    ...
    <title>1931女子偶像组合</title>
    <meta content="1931女子偶像组合" name="Keywords">
    <meta content="1931是国内首支由纳斯达克上市公司聘请港台专属造星团队、注资5亿精心打造的全民少女偶像天团。" name="Description">
    <link rel="icon" href="http://res.1931.yystatic.com/dream/images/favicon.ico" type="image/x-icon"/>
    <style>
        html {
            overflow-y: scroll;
...
<div class="error">
    ...
    <p><b id="timer">点击</b><a href="http://1931.yy.com/">返回</a>地球</p>
</div>
